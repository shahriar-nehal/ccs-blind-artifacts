...
This folder contains the full Android Studio source code for the experimental applications developed to systematically trigger the BLIND attack. To run the PoC:
